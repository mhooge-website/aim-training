...
function drawNumber(n, x, y) {
    ...
    let id = setInterval(() => {
        ...
        canvashelper_1.CanvasHelper.setFillColor("rgb(255, 255, 255)");
...
class Game {
    ...
    createTarget(x, y, d) {
        let pos = canvashelper_1.CanvasHelper.getRelativePos(x, y, this.canvas);
    ...
    targetHit(target) {
        canvashelper_1.CanvasHelper.setFillColor("rgb(255, 255, 255)");
        canvashelper_1.CanvasHelper.fillCircle(target.x, target.y, target.d);
        this.targetsHit += 1;
...
exports.Game = Game;
},{"./canvashelper":2,"./target":8,"jquery":1}],5:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
class GameHoldAngle extends game_1.Game {
    ...
    drawHead(x, y, d) {
        canvashelper_1.CanvasHelper.setFillColor("rgb(255, 0, 0)");
        canvashelper_1.CanvasHelper.fillCircle(x, y, d / 2);
    }
    animatePeek(x, y, target, scale) {
    ...
    getPeekPosition() {
        ...
        if (scale < 0.2)
            scale = 0.2;
        if (x + this.wallWidth > this.canvas.width)
            x = this.canvas.width - this.wallWidth;
        return { x: x, scale: scale };
    }
    targetHit(target) {
        super.targetHit(target);
        canvashelper_1.CanvasHelper.eraseAll(this.canvas);
        this.activeTargets = [];
    ...
    gameLoop() {
        ...
        countdown_1.Countdown.createCountdown(peekPos.x + this.wallWidth + 5, headPos.top - 10);
...
},{"./canvashelper":2,"./countdown":3,"./game":4}],6:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const game_1 = require("./game");
const canvashelper_1 = require("./canvashelper");
...
class GameFlick extends game_1.Game {
    ...
    getTargetPos() {
        ...
        if (y > this.canvas.height - this.targetDiameter)
            y = this.canvas.height - this.targetDiameter;
        return {
    ...
    gameLoop() {
        ...
        setTimeout(() => {
            ...
            canvashelper_1.CanvasHelper.drawLine(1300, 300, 1300, 400);
        }, 4000);
    }
}
exports.GameFlick = GameFlick;
},{"./canvashelper":2,"./countdown":3,"./game":4}],7:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./gamemode1":5,"./gamemode2":6,"jquery":1}],8:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
class Target {
    constructor(x, y, d) {
